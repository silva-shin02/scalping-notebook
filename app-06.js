            ...
            React.createElement("table", { style: { borderCollapse: "collapse", width: "auto", minWidth: "100%", fontSize: 11 } },
              ...
              React.createElement("tbody", null, _diffResKeys.map(function(k) {
                ...
                return React.createElement("tr", { key: k },
                  ...
                  _drTd(_elHoldSumBoth(m.holdCnt > 0 ? m.hold : null, m.hold2Cnt > 0 ? m.hold2 : null))
                );
              }))
            )
          )
      ...
      (function() {
        ...
        var _tRow = function(date, st, gradeReal, gradePlan, gradeMax, tags, recs) {
          ...
          return React.createElement("tr", { key: date,
            ...
            React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: bb, borderRight: br } },
              isHoliday ? _dash : (_simActive
                ? React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 3, flexWrap: "wrap", justifyContent: "center" } },
                    React.createElement("span", null, React.createElement("span", { style: { fontSize: 8, color: "#bbb", fontWeight: 700, marginRight: 1 } }, "①"), _tAB2(_simSt.holdCapAB, _simSt.holdCap)),
                    React.createElement("span", { style: { color: "#ddd" } }, "｜"),
                    React.createElement("span", null, React.createElement("span", { style: { fontSize: 8, color: "#bbb", fontWeight: 700, marginRight: 1 } }, "②"), (st.sumHold2 == null ? React.createElement("span", { style: { color: "#ccc" } }, "—") : React.createElement("span", { style: { fontWeight: 700, color: st.sumHold2 > 0 ? "#C0392B" : st.sumHold2 < 0 ? "#1E8449" : "#888" } }, (st.sumHold2 > 0 ? "+" : "") + st.sumHold2.toLocaleString() + "円"))))
                : _elHoldSumBoth(st.sumHold, st.sumHold2))),
            React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: bb, borderRight: br } },
        ...
        var _tExpRow = function(date) {
          ...
          var _totPlanAB = null;
          var _totPlanABCnt = 0;
          var _totHold2 = null, _totHold2Cnt = 0;
          recs.forEach(function(r) {
            ...
            React.createElement("td", { style: { padding: "4px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderTop: "2px solid #FB923C", borderLeft: "1px solid #f0ede6" } },
              React.createElement("div", { style: { display: "inline-flex", alignItems: "flex-start", gap: 6, flexWrap: "wrap", justifyContent: "center" } },
                React.createElement("div", null,
                  ...
                  (_totHoldPlanStopDiff && _totHold != null) ? React.createElement("div", { title: "損切りせず保有し続けた場合の本来の結果損益合計（100株換算）", style: { display: "inline-flex", alignItems: "center", justifyContent: "center", whiteSpace: "nowrap", lineHeight: 1.2, marginTop: 1 } }, React.createElement("span", { style: { fontSize: 11, color: "#333", fontWeight: 700 } }, "（"), _tBadge(_profitGradeFromPnl(_totHold, _totHoldCnt)), React.createElement("span", { style: { fontSize: 11, color: "#333", fontWeight: 700 } }, _totHold.toLocaleString() + "円）")) : null),
                React.createElement("span", { style: { color: "#ddd", alignSelf: "center" } }, "｜"),
                React.createElement("div", null,
                  _lblCtot("H②合計"),
                  _totHold2Cnt > 0
                    ? (function() { var _g2 = _profitGradeFromPnl(_totHold2 != null ? _totHold2 : 0, _totHold2Cnt); return React.createElement("span", { style: { display: "inline-flex", alignItems: "center", whiteSpace: "nowrap" } }, _g2 ? _tBadge(_g2) : null, React.createElement("span", { style: { fontWeight: 600, color: _totHold2 > 0 ? "#C0392B" : _totHold2 < 0 ? "#1E8449" : "#888" } }, (_totHold2 > 0 ? "+" : "") + (_totHold2 || 0).toLocaleString() + "円")); })()
                    : React.createElement("span", { style: { color: "#ccc" } }, "—"))
              )
            ),
                ...
                React.createElement("table", { style: { width: "auto", borderCollapse: "collapse", fontSize: 11 } },
                  React.createElement("thead", null,
                    React.createElement("tr", null,
                      _rTh("銘柄", { textAlign: "left", width: 60 }), _rTh("時間", { width: 44 }), _rTh("シグナル", { width: 130 }), _rTh(React.createElement("span", null, "予想", React.createElement("span", { style: { display: "block", whiteSpace: "nowrap" } }, "OS度")), { width: 40 }), _rTh("α値", { width: 32 }), _rTh("OS値", { width: 44 }), _rTh("確定値", { width: 50 }), _rTh("α値比値幅", { width: 48 }), _rTh("E", { width: 30 }),
                      _rTh("想定損益", { width: 96 }), _rTh(React.createElement("span", null, "H ", React.createElement("span", { style: { fontSize: 9, color: "#888", fontWeight: 400 } }, "①H1/②H2")), {}), _rTh("実現損益", { width: 84 })
                    )
                  ),
        ...
        var _tMonthRow = React.createElement("tr", { key: "__monthtot__", style: { background: "#F5F0E8" } },
          ...
          React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: _bb2, borderTop: _bb2 } },
            _tMSimActive
              ? React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 3, flexWrap: "wrap", justifyContent: "center" } },
                  React.createElement("span", null, React.createElement("span", { style: { fontSize: 8, color: "#bbb", fontWeight: 700, marginRight: 1 } }, "①"), _tAB2(_tMSimSt.holdCapAB, _tMSimSt.holdCap)),
                  React.createElement("span", { style: { color: "#ddd" } }, "｜"),
                  React.createElement("span", null, React.createElement("span", { style: { fontSize: 8, color: "#bbb", fontWeight: 700, marginRight: 1 } }, "②"), (_tMonthSt.sumHold2 == null ? React.createElement("span", { style: { color: "#ccc" } }, "—") : React.createElement("span", { style: { fontWeight: 700, color: _tMonthSt.sumHold2 > 0 ? "#C0392B" : _tMonthSt.sumHold2 < 0 ? "#1E8449" : "#888" } }, (_tMonthSt.sumHold2 > 0 ? "+" : "") + _tMonthSt.sumHold2.toLocaleString() + "円"))))
              : _elHoldSumBoth(_tMonthSt.sumHold, _tMonthSt.sumHold2)),
          React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: _bb2, borderTop: _bb2 } },
          ...
          return React.createElement("div", { style: { margin: "14px 0 10px", padding: "12px 14px", background: "#FFFBF5", border: "1.5px solid #FB923C", borderRadius: 8 } },
            ...
            _simA == null
              ...
              : React.createElement("div", { style: { display: "flex", gap: 20, flexWrap: "wrap", alignItems: "center" } },
                  ...
                  React.createElement("div", null,
                    React.createElement("div", { style: { fontSize: 10, color: "#888", marginBottom: 2 } }, "H②結果損益合計（" + _sTotHold2Cnt + "件・○/△）"),
                ...
                React.createElement("tbody", null,
                  [1, 2, 3, 4, 5].map(function(wd) {
                    ...
                    return React.createElement("tr", { key: wd },
                      ...
                      React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 12, whiteSpace: "nowrap", borderBottom: bb, borderRight: br } },
                        wrecs.length > 0 ? _elHoldSumBoth(wst.sumHold, wst.sumHold2) : _dash),
                ...
                React.createElement("tbody", null,
                  (function() {
                    ...
                    if (_dtDiffKeys.length === 0) {
                      return React.createElement("tr", null, React.createElement("td", { colSpan: 7, style: { padding: 10, textAlign: "center", color: "#aaa", fontSize: 11 } }, "該当なし"));
                    }
                    ...
                    return _dtDiffKeys.map(function(dk) {
                      ...
                      return React.createElement("tr", { key: dk },
                        ...
                        React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 12, whiteSpace: "nowrap", borderBottom: _bbd, borderRight: _bbd } }, _elHoldSumBoth(dst.sumHold, dst.sumHold2)),
  ...
  var renderStockView = function() {
    ...
    var _svRow = function(date, st, gradeReal, gradePlanned, gradeMax, tags) {
      ...
      return React.createElement("tr", { key: date,
        ...
        React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: bb, borderRight: br } },
          isHoliday ? _dash : _elHoldSumBoth(st.sumHold, st.sumHold2)),
        React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", fontSize: 11, whiteSpace: "nowrap", borderBottom: bb, borderRight: br } },
      ...
      recs.forEach(function(r) {
        ...
        subRows.push(
          React.createElement("tr", { key: rKey,
            ...
            React.createElement("td", { style: { padding: "4px 6px", textAlign: "center", fontSize: 11, borderBottom: "1px solid #f0ede6", borderRight: "1px solid #f0ede6" } },
              _elHoldBoth(s, _aiSv.alpha, _aiSv.cutLine),
        ...
        if (rExp) {
          subRows.push(
            React.createElement("tr", { key: rKey + "_card" },
              React.createElement("td", { colSpan: 9, style: { padding: "4px 8px 8px", background: "#FFFBF5", borderBottom: "1px solid #f0ede6" } },
          ...
          React.createElement("div", { style: { display: "inline-flex", alignItems: "flex-start", gap: 6, flexWrap: "wrap", justifyContent: "center" } },
            React.createElement("div", null,
              ...
              _totHoldCnt > 0
                ...
                : React.createElement("span", { style: { color: "#ccc" } }, "—"),
              (_totHoldStop && _totHoldCap != null) ? _elCapNoteAmt(_totHoldCap) : null,
              (_totHoldPlanStopDiff && _totHold != null) ? React.createElement("div", { title: "損切りせず保有し続けた場合の本来の結果損益合計（100株換算）", style: { display: "inline-flex", alignItems: "center", justifyContent: "center", whiteSpace: "nowrap", lineHeight: 1.2, marginTop: 1 } }, React.createElement("span", { style: { fontSize: 11, color: "#333", fontWeight: 700 } }, "（"), _svBadge(_profitGradeFromPnl(_totHold, _totHoldCnt)), React.createElement("span", { style: { fontSize: 11, color: "#333", fontWeight: 700 } }, _totHold.toLocaleString() + "円）")) : null),
            React.createElement("span", { style: { color: "#ddd", alignSelf: "center" } }, "｜"),
            React.createElement("div", null,
              _lblSvtot("H②合計"),
              _totHold2Cnt > 0
                ? (function() { var _g2 = _profitGradeFromPnl(_totHold2 != null ? _totHold2 : 0, _totHold2Cnt); return React.createElement("span", { style: { display: "inline-flex", alignItems: "center", whiteSpace: "nowrap" } }, _g2 ? _svBadge(_g2) : null, React.createElement("span", { style: { fontWeight: 600, color: _totHold2 > 0 ? "#C0392B" : _totHold2 < 0 ? "#1E8449" : "#888" } }, (_totHold2 > 0 ? "+" : "") + (_totHold2 || 0).toLocaleString() + "円")); })()
                : React.createElement("span", { style: { color: "#ccc" } }, "—"))
          )
        ),
      ...
      return React.createElement("div", { style: { padding: "10px 12px", background: "#fff" } },
        ...
        React.createElement("div", { style: { overflowX: "auto" } },
          React.createElement("table", { style: { borderCollapse: "collapse", width: "100%", fontSize: 11 } },
            React.createElement("thead", null,
              React.createElement("tr", { style: { background: "#f5f4f0" } },
                _hh("日付", { textAlign: "left", paddingLeft: 8 }), _hh("時間"), _hh("銘柄"), _hh("OS値"), _hh("確定値"), _hh("α値比値幅"), _hh("想定損益"), _hh(React.createElement("span", null, "H ", React.createElement("span", { style: { fontSize: 9, color: "#888", fontWeight: 400 } }, "①H1/②H2")))
              )
            ),
        ...
        acc.push(React.createElement("tr", {
          ...
          React.createElement("td", { style: { padding: "5px 6px", textAlign: "right", borderBottom: slotOn ? "none" : "1px solid #f0ede8", fontSize: 11, whiteSpace: "nowrap" } },
            hasRecs ? _tABAll(ss.recs, ss.stats.sumPlanned, ss.stats.expectedPlanned, null, "sumPlanned", "expectedPlanned")
                    : React.createElement("span", { style: { color: "#ccc" } }, "—")),
          React.createElement("td", { style: { padding: "5px 6px", textAlign: "right", borderBottom: slotOn ? "none" : "1px solid #f0ede8", fontSize: 11, whiteSpace: "nowrap" } },
            hasRecs ? _elHoldSumBoth(ss.stats.sumHold, ss.stats.sumHold2) : React.createElement("span", { style: { color: "#ccc" } }, "—"))
        ));
      ...
      return React.createElement("div", null,
        ...
        (function() {
          ...
          return React.createElement("tr", { style: { background: "#F5F0E8", borderBottom: "2px solid #ccc" } },
            ...
            React.createElement("td", { style: { padding: "5px 6px", textAlign: "right", borderBottom: "2px solid #ccc", fontSize: 11, whiteSpace: "nowrap" } },
              _elHoldSumBoth(at.sumHold, at.sumHold2))
          );
        })(),
        timeSlotRows
      )
              ...
              React.createElement("tbody", null,
                dkeys.map(function(dk) {
                  ...
                  return React.createElement("tr", {
                    ...
                    React.createElement("td", { style: { padding: "5px 6px", textAlign: "center", borderBottom: "1px solid #f0ede8", fontSize: 11, whiteSpace: "nowrap" } },
                      _elHoldSumBoth(dst.sumHold, dst.sumHold2))
                  );
                })
              )
            )
              ...
              React.createElement("tbody", null,
                [1, 2, 3, 4, 5].map(function(wd) {
                  ...
                  return React.createElement("tr", { key: wd },
                    ...
                    React.createElement("td", { style: { padding: "5px 6px", textAlign: "right", borderBottom: "1px solid #f0ede8", fontSize: 11, whiteSpace: "nowrap" } },
                      wrecs.length > 0
                        ? _elHoldSumBoth(wst.sumHold, wst.sumHold2)
                        : React.createElement("span", { style: { color: "#ccc" } }, "—"))
                  );
                })
              )
              ...
              React.createElement("tbody", null,
                skeys.map(function(sk) {
                  ...
                  return React.createElement("tr", {
                    ...
                    React.createElement("td", { style: { padding: "5px 6px", textAlign: "right", borderBottom: "1px solid #f0ede8", fontSize: 11, whiteSpace: "nowrap" } },
                      _elHoldSumBoth(sst.sumHold, sst.sumHold2))
                  );
                })
              )
            )
              ...
              React.createElement("tbody", null,
                ...
                React.createElement("tr", { style: { background: "#F5F0E8", borderBottom: "2px solid #ccc" } },
                  ...
                  React.createElement("td", { key: "tot_3", style: { padding: "5px 6px", textAlign: "right", borderBottom: "2px solid #ccc", fontSize: 11, whiteSpace: "nowrap" } },
                    _elHoldSumBoth(allSt.sumHold, allSt.sumHold2))
                ),
    ...
    return React.createElement("div", { style: { paddingTop: 4 } },
      ...
      React.createElement("div", {
        ...
        React.createElement("div", { style: { display: "flex", gap: 14, flexWrap: "wrap", fontSize: 13, marginTop: 8, paddingTop: 8, borderTop: "1px dashed " + _pnlGS.border } },
          ...
          React.createElement("div", null,
            React.createElement("span", { style: { color: "#888" } }, "1日平均 H①結果損益 "),
