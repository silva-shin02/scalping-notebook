...
function EntryLogView(_ref_elv2) {
  ...
  var _uSGT = useState("uki"), sigSub = _uSGT[0], setSigSub = _uSGT[1];   // 📡シグナル総合ピルのサブタブ: band(株価帯別・先頭・2026-07-22i移設)/uki(浮き足%)/rn(RN) 2026-07-12（tod/dowは2026-07-16撤去）。既定は"uki"据置（bandは左に足すだけ）
